...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.button-class[data-v-6a63e488]{\n    border: solid 1px black;\n    border-radius: 0.5rem;\n    padding: 1rem;\n    transition: 0.5s ease-in-out;\n}\n.button-class[data-v-6a63e488]:hover{\n    background-color:rgb(99,102,241) ;\n    color: white;\n}\n", ""]);
// Exports
...
var render = function() {
  ...
  return _c("div", { staticClass: "home" }, [
    ...
    _c(
      ...
      {
        staticClass:
          "border border-black p-4 rounded-lg hover:bg-indigo-500 hover:text-white transition duration-300 ease-in-out",
        on: {
          click: function($event) {
            return _vm.$store.commit("INCREMENT")
          }
