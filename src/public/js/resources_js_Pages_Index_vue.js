...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "desktop" }, [
      _c("div", { staticClass: "skew-bg flex" }, [
        _c(
          "div",
          ...
          [
            _c("router-link", { attrs: { to: "/recorder" } }, [
              _c("img", {
                staticStyle: { "max-width": "65%", "margin-left": "25%" },
        ...
        _c(
          ...
          {
            staticClass:
              "absolute right-0 text-4xl text-right pr-6 leading-relaxed",
            staticStyle: { top: "58%", transform: "translateY(-50%)" }
          },
          [
            ...
            _c("input", {
              staticClass:
                "block w-40 my-8 px-4 py-1.5 rounded-full text-xl leading-tight",
            ...
            _c(
              ...
              {
                staticClass:
                  "w-14 h-14 bg-white rounded-full p-3.5 flex justify-center items-center shadow-md float-right cursor-pointer hover:opacity-60"
              },
              [
                _c("box-icon", {
    ...
    _vm._v(" "),
    _c("div", { staticClass: "mobile relative" }, [
