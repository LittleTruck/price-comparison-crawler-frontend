...
/* harmony import */ var vue_spinner_src_ClipLoader__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! vue-spinner/src/ClipLoader */ "./node_modules/vue-spinner/src/ClipLoader.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ClipLoader: vue_spinner_src_ClipLoader__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
  methods: {
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                axios__WEBPACK_IMPORTED_MODULE_2___default().post("".concat(url), recognition).then(function (res) {
                  ...
                  _this3.$store.commit("SET_LOWEST_PRODUCT", res.data.table_recommand_lowest[0]);

                  _this3.$store.commit("SET_DISCOUNT_PRODUCT", res.data.table_recommand_discount[0]);

                  _this3.$store.commit("SET_HIGHEST", res.data.Quartile.highestPrice);

                  _this3.$store.commit("SET_LOWEST", res.data.Quartile.lowestPrice);

                  _this3.$store.commit("SET_MEDIAN", res.data.Quartile.median);

                  _this3.$store.commit("SET_NORMAL25", res.data.Quartile.normalPrice25);

                  _this3.$store.commit("SET_NORMAL75", res.data.Quartile.normalPrice75);
    ...
    [
      _vm.loading
        ? _c("clip-loader", {
            ...
            attrs: { color: "white", size: "100px" }
          })
        : _vm._e(),
      _vm._v(" "),
      _c("div", { staticStyle: { "background-color": "#e6e6e6" } }, [
        _c("div", { staticClass: "relative" }, [
          _c("div", { staticClass: "skew-bg-mobile" }),
          _vm._v(" "),
          _c(
            "div",
            {
              ...
              _c("label", { attrs: { for: "pic_input" } }, [
                !_vm.preview
                  ? _c("img", {
                      ...
                      attrs: { src: "/images/click_to_photo.gif", alt: "" }
                    })
                  : _c(
                      "span",
                      {
                        staticClass:
                          "absolute rounded-full z-10 p-4 overflow-hidden",
                        staticStyle: {
                          top: "50%",
                          left: "50%",
                          width: "26rem",
                      ...
                      [
                        _vm.preview
                          ? _c(
                              ...
                              {
                                staticClass:
                                  "w-full h-full bg-white rounded-full overflow-hidden flex p-8"
                              },
                              [
                                _c("input", {
                                  ref: "file",
                        ...
                        _vm.preview
                          ? _c(
                              ...
                              {
                                staticClass:
                                  "absolute w-full h-32 flex justify-center items-center bottom-0 left-0 text-white text-2xl z-10 hover:-translate-y-1",
                                staticStyle: {
                ...
                !_vm.preview
                  ? _c("input", {
                      ref: "file",
                      staticClass:
                        "absolute bg-black px-20 rounded-full opacity-0 cursor-pointer z-10",
                      staticStyle: {
                        left: "50%",
                        top: "50%",
                        transform: "translate(-50%,-50%)",
          ...
          _c(
            ...
            {
              staticClass:
                "relative z-50 flex flex-wrap w-full justify-center px-24 pb-32",
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticStyle: { "margin-top": "-65%" } }, [
      _c(
        "div",
        {
          staticClass:
            "absolute right-0 text-5xl text-right pr-12 leading-tight"
        },
        [
          _c("div", { staticClass: "text-gray-500" }, [_vm._v("or")]),
          _vm._v(" "),
          _c("div", [_vm._v("enter")]),
          _vm._v(" "),
          _c("div", [_vm._v("keywords")])
        ]
      )
    ])
  }
